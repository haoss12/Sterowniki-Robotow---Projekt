...
/* Private defines -----------------------------------------------------------*/
#define SERVO_YAW1_Pin GPIO_PIN_0
#define SERVO_YAW1_GPIO_Port GPIOA
#define SERVO_YAW2_Pin GPIO_PIN_1
#define SERVO_YAW2_GPIO_Port GPIOA
#define SERVO_PITCH1_Pin GPIO_PIN_2
#define SERVO_PITCH1_GPIO_Port GPIOA
#define SERVO_PITCH2_Pin GPIO_PIN_3
#define SERVO_PITCH2_GPIO_Port GPIOA
#define TEMP_SENS_1WIRE_Pin GPIO_PIN_5
#define TEMP_SENS_1WIRE_GPIO_Port GPIOA
